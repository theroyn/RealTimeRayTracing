...
public:
    ...
    void AddInstance(size_t modelIdx, const DirectX::XMMATRIX& transform);
...
private:
    ...
    std::map<size_t /**model idx*/, std::vector<DirectX::XMMATRIX> /** model instance transforms*/> _instances;
};
